...
class VanillaEuropeanOptionTest(unittest.TestCase):
    ...
    def test_call_option(self):
        self.assertEqual(round(self.call_option.get_value(), 4), 2.1334, 'Call option value test failed.')

    def test_put_option(self):
        self.assertEqual(round(self.put_option.get_value(), 4), 2.4648, 'Put option value test failed.')
